...
async function fetchProducts() {
    try {
      ...
      products.forEach(product => {
        addCard(product.title, product.price, product.image);
      });
    } catch (error) {
...
function productCardTemplate(productTitle, productPrice, productImage) {
    return `
    <div class="col-md-4 mb-5">
            <div class="card h-100">
                ...
                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                    <div class="text-center">
                        <a class="btn btn-outline-dark mt-auto" href="#" onclick="addToCart('${productTitle}', ${productPrice})">Add to cart</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    function addCard(productTitle, productPrice, productImage) {
        const cardHtml = productCardTemplate(productTitle, productPrice, productImage);
